# -*- coding: utf-8 -*-
"""
AutoHotCorner v8 (PyQt5 single-file)
...
- Window size option
- NEW in v8:
  * Reverted About label to classic text
  * Added configurable "핫코너 연타 방지 딜레이(ms)" option (default 500ms)
"""
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        gl3.addWidget(QLabel("핫코너 연타 방지 딜레이:"), 6, 0)
        gl3.addWidget(self.spin_cooldown, 6, 1)
